...
Locator Strategy
Prefer getByRole locators for best accessibility and resilience

Use other semantic locators like getByText, getByLabel, getByPlaceholder when appropriate
