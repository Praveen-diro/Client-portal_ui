                    ...
                    >
                      {card.secondaryValue ? (
                        ...
                        <>
                          <div className="text-3xl font-bold">{card.mainValue}</div>
                          <p className="text-xs text-muted-foreground mt-1">{card.description}</p>
                          {card.subValue && <p className={`text-sm mt-2 ${card.subValueColor} font-medium`}>{card.subValue}</p>}
                        </>
                      )}
                    </motion.div>
                  ...
                  >
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <Download className={`h-4 w-4 ${button.category === "Address" ? "text-green-500" : "text-blue-500"}`} />
                        <Badge
                          variant="outline"
                          className={
                            button.category === "Address" ? "border-green-500 text-green-700" : "border-blue-500 text-blue-700"
                          }
                        >
                          {button.category}
                        </Badge>
