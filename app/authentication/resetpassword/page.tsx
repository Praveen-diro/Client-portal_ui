                      ...
                      {!isSubmitted ? (
                        <motion.div variants={formVariants} initial="hidden" animate="visible" exit="exit" className="space-y-6">
                          <div className="space-y-2 text-center">
                            <h2 className="text-2xl font-semibold text-slate-800 dark:text-white">Reset Password</h2>
                        ...
                        >
                          <div className="space-y-4">
                            ...
                            <h2 className="text-2xl font-semibold text-slate-800 dark:text-white">Password Reset Successfully</h2>
                            <p className="text-slate-600 dark:text-gray-300 text-sm">
