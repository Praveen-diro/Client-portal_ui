        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>We're here to help! Please provide details about the issue you're experiencing.</CardDescription>
            </CardHeader>
            <CardContent>
              <motion.div variants={formContainer} initial="hidden" animate="show" className="space-y-6">
                <motion.div variants={formItem} className="space-y-2">
                  ...
                  <Input id="email" type="email" placeholder="Enter your email" defaultValue="praveen@diro.io" className="h-9" />
                </motion.div>
